...
def arg_parse():
    ...
    parser.add_argument("--reso", dest = 'reso', help = "Input resolution of the network. Increase to increase accuracy. Decrease to increase speed",default = "608", type = str)
...
loaded_imgs = [cv2.imread(img_path) for img_path in imlist]
...
im_batches = list(map(prep_image,loaded_imgs, [inp_dim for x in range(len(imlist))]))
